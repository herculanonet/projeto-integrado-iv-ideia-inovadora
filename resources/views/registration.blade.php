        ...
        <div class="row mb-4 justify-content-center">
            <div class="col-md-6">
                ...
                <div class="card border-0">
                    <h3 class="p-3 mt-3 card-header bg-transparent border-0 text-center">Faça seu Registro</h3>
                    <div class="card-body">
                        <form action="{{ route('registration.post') }}" method="POST" class="form-signin">
                            @csrf
                            <div class="form-group mb-3">
                                <input type="text" name="name" placeholder="Name" id="name" class="rounded form-control" name="name" required autofocus>
                                @if ($errors->has('name'))
                            ...
                            <div class="d-grid mx-auto">
                                <button type="submit" class="btn btn-primary btn-block btn-lg">Cadastrar-se</button>
                            </div>
                        </form>
                    </div>
                </div>
